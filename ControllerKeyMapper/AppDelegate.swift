...
let helperAppID: CFString = "jp.0spec.ControllerKeyMapperLauncher" as CFString
...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        self.windowController = storyboard.instantiateController(withIdentifier: "ControllerKeyMapperWindowController") as? NSWindowController
