...
1. BluetoothでコントローラをMacへ接続する
    ...
    ![screenshot_usage_1_3](https://github.com/magicien/ControllerKeyMapper/blob/master/lang/ja/screenshot_3.png)
...
2. キー設定
    ...
    ![screenshot_usage_2_2](https://github.com/magicien/ControllerKeyMapper/blob/master/lang/ja/screenshot_4.png)    

    2.3 キー設定を行うアプリケーションを追加する（任意）
    
    ![screenshot_usage_2_3](https://github.com/magicien/ControllerKeyMapper/blob/master/lang/ja/screenshot_5.png)    
    
    2.4 キー設定を行うボタンをクリックする
    
    ![screenshot_usage_2_4_1](https://github.com/magicien/ControllerKeyMapper/blob/master/lang/ja/screenshot_6.png)
